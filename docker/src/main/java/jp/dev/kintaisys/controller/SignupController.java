...
import jp.dev.kintaisys.application.service.UserApplicationService;
...
public class SignupController {
	...
	public String postSignup(Model model, Locale locale, @ModelAttribute @Validated(GroupOrder.class) SignupForm form,
		...
		taskForm.setId(user.getId());
		taskForm.setLoginId(user.getLoginId());

		// taskFormをKintairクラスに変換)
		Kintai kintai = modelMapper.map(taskForm, Kintai.class);
		taskService.signup(user, kintai);
